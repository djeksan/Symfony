...
class BrandController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $brands = $em->getRepository('DefaultBundle:Brand')->findAll();
    ...
    {
        $brand = new Brand();
        $form = $this->createForm('DefaultBundle\Form\BrandType', $brand);
    ...
    {
        $deleteForm = $this->createDeleteForm($brand);
        $editForm = $this->createForm('DefaultBundle\Form\BrandType', $brand);
